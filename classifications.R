...
boxplot(psa, capsule, main = "Race vs PSA", xlab = "Peneration vs Non Preneration", ylab = "PSA (mg/mL)")
boxplot(age, capsule, main = "Age vs PSA", xlab = "Peneration vs Non Preneration", ylab = "PSA (mg/mL)")
